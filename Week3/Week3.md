...
--- | --- | --- 
MFC heroes (рабочие) | Evolveability, Modifiability, Maintainability, Agility, Testability, Deployability | Консерны топ менеджмента, низкий ТТМ
...
Equipment | - | Можно посадить джунов пилить. На первый взгляд других характеристик выделить не могу, но есть опасения что со временем понадобятся Modifiability, Agility, Testability, если бизнес решит как-то разививать сборку материалов (чек листы, таргетирование под клиентов, не только печеньку, но и шоколадку)
